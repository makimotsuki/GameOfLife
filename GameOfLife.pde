...
public int countNeighbors(int row, int col) {
  int neighbors = 0;
  //your code here
  if (isValid(row+1,col+1) == true && buttons[row+1][col+1].getLife())
    neighbors++;
  if (isValid(row-1,col-1) == true && buttons[row-1][col-1].getLife())
    neighbors++;
  if (isValid(row,col+1) == true && buttons[row][col+1].getLife())
    neighbors++;
  if (isValid(row,col-1) == true && buttons[row][col-1].getLife())
    neighbors++;
  if (isValid(row+1,col) == true && buttons[row+1][col].getLife())
    neighbors++;
  if (isValid(row-1,col) == true && buttons[row-1][col].getLife())
    neighbors++;
  if (isValid(row+1,col-1) == true && buttons[row+1][col-1].getLife())
